...
const BottomNavi = () => {
    ...
    return (
        <div className='bottom-navi'>
            ...
            <button onClick={() => navigate('/account')} className={`bottom-navi-btn ${pathname === '/account' ? 'active' : ''}`}><i className="fa-regular fa-circle-user"></i><span>Account</span></button>
            ...
            {/* <button onClick={() => navigate('/search-items')} className='bottom-navi-btn'><i className="fa-solid fa-mobile-screen"></i><span>Call</span></button> */}
            <button onClick={onClose} className='bottom-navi-btn'><i className="fa-solid fa-arrow-left"></i><span>Back</span></button>
        </div>
    )
}
