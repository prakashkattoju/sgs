...
const BottomNavi = () => {
    ...
    return (
        <div className='bottom-navi'>
            ...
            <a role='button' href='tel:9177965769' className='bottom-navi-btn'><i className="fa-solid fa-mobile-screen"></i><span>Call</span></a>
            ...
            <button onClick={() => navigate('/account')} className={`bottom-navi-btn ${pathname === '/account' || pathname === '/order-details' ? 'active' : ''}`}><i className="fa-regular fa-circle-user"></i><span>You</span></button>
        </div>
    )
}
